...
{
    /// <summary>
    /// Helper methods to apply EF Core migrations and seed initial identity data for development/testing environments.
    /// </summary>
    public static class DbMigrationHelpers
    {
        /// <summary>
        /// Applies database migrations and seeds data when the application starts.
        /// This is an extension method for <see cref="WebApplication"/> to be called during app startup.
        /// </summary>
        ...
        /// <summary>
        /// Ensures database migrations are applied and seed data is present using the application's services.
        /// </summary>
        /// <param name="application">The running <see cref="WebApplication"/> from which to create a service scope.</param>
        ...
        /// <summary>
        /// Ensures database migrations are applied and seed data is present using the provided service provider.
        /// This will only run in Development or a custom "Testing" environment.
        /// </summary>
        /// <param name="serviceProvider">The root <see cref="IServiceProvider"/> used to create a scope for resolving required services.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
