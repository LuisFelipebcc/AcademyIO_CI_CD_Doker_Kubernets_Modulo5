...
namespace AcademyIO.Auth.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        /// - creates an Identity user with the provided password,
        /// - assigns the appropriate role,
        /// - publishes an integration event to create the user in other systems,
        /// - and returns a JWT token when successful.
        /// </summary>
