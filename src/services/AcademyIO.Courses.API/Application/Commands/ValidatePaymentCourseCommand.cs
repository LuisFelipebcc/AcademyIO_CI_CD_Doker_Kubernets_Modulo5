...
{
    public class ValidatePaymentCourseCommand(Guid courseId, Guid studentId, string cardName,
        string cardNumber, string cardExpirationDate, string cardCVV) : Command
    {
